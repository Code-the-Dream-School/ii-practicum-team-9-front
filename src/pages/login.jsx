...
export default function Login({ setIsAuthenticated }) {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      console.log(error);
      const errMsg =
        error.response?.msg || error.message || "An error occurred.";
      setError(errMsg);
      ...
      <div className={styles.loginContainer}>
        <div className={styles.loginForm}>
          ...
          <p className={styles.subtitle}>
            Barter App - Where community comes together to exchange, engage, and
            support one another
          </p>
        ...
        <div
          ...
          style={{ backgroundImage: `url(${backgroundBarter})` }}
        ></div>
      </div>
    </div>
  );
